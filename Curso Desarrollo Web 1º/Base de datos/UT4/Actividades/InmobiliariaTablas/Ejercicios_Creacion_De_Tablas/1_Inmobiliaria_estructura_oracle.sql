...
COMMENT ON COLUMN TIPO_INMUEBLE.DESCRIPCION IS 'Descripción del tipo de inmueble';
...
COMMENT ON COLUMN INMUEBLE.DIRECCION IS 'Dirección del inmueble';
COMMENT ON COLUMN INMUEBLE.POBLACION IS 'Población del inmueble';
COMMENT ON COLUMN INMUEBLE.CODIGO_POSTAL IS 'Código Postal del inmueble';
...
COMMENT ON COLUMN INMUEBLE.FECHA_ULTIMO_MOV IS 'Fecha del último movimiento del inmueble';
...
COMMENT ON COLUMN ESTADO.DESCRIPCION IS 'Descripción del estado del inmueble';
...
COMMENT ON COLUMN TIPO_MOVIMIENTO.DESCRIPCION IS 'Descripción del tipo de movimiento del inmueble';
...
COMMENT ON COLUMN CLIENTE.POBLACION IS 'Población del cliente';
COMMENT ON COLUMN CLIENTE.EMAIL IS 'Dirección de correo del cliente';
...
COMMENT ON COLUMN HORARIO.CODIGO IS 'Código del tipo de horario';
COMMENT ON COLUMN HORARIO.DESCRIPCION IS 'Descripción del tipo de horario';
...
COMMENT ON COLUMN AGENTE.DIRECCION IS 'Dirección del Agente';
COMMENT ON COLUMN AGENTE.POBLACION IS 'Población del Agente';
...
COMMENT ON COLUMN MOVIMIENTO.ID_INMUEBLE IS 'Identificador del Inmueble sobre el que se realizó el alquiler/venta';
COMMENT ON COLUMN MOVIMIENTO.CODIGO_TIPO_MOVIMIENTO IS 'Tipo del Movimiento: alquiler/venta';
COMMENT ON COLUMN MOVIMIENTO.CLIENTE_DNI IS 'DNI del cliente que realizó el movimiento';
COMMENT ON COLUMN MOVIMIENTO.AGENTE_DNI IS 'DNI del agente que realizó el movimiento';
...
COMMENT ON COLUMN COMISION.ID_COMISION IS 'Identificador de la comisicón';
COMMENT ON COLUMN COMISION.IMPORTE IS 'Importe de la comisión';
COMMENT ON COLUMN COMISION.FECHA_CALCULO IS 'Fecha de la comisión';
COMMENT ON COLUMN COMISION.AGENTE_DNI IS 'Agente al que le pertenece la comisión';